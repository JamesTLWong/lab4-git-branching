...
def left_path():
    ...
    print("The wizard tells you that the sword was very cursed, but they have removed the curse and now you are left a sword that would fetch quite the price with collectors")
    print("You end up selling the sword for a high price, leaving you and your family very well off.")
